<div class="sm:grid sm:grid-cols-3 mt-10">
    <div class="mb-6 px-4 sm:px-0">
        ...
        <p class="font-extralight text-sm text-gray-700 mt-1">Upload or remove team logo.</p>
    </div>
        ...
        <div class="pt-6 pb-10 px-2 sm:px-12 border-b border-gray-200 bg-white">
            <form wire:submit.prevent="save">
                ...
                <div class="mt-2 mb-4 flex justify-between">
                    <img src="{{asset('storage/'.$logo)}}" alt="" class="rounded-full h-20 w-20 object-cover">
                </div>
                ...
                <x-jet-input 
                    wire:model="photo" 
                    type="file" 
                    class="p-1 shadow border hover:border-indigo-300 rounded w-full" 
                    accept=".jpg, .jpeg"/>
                ...
                <div class="flex justify-end mt-4 gap-2">
                    ...
                    <x-jet-secondary-button wire:click="recoverOldLogo">Recover</x-jet-button>
                    <x-jet-danger-button wire:click="delete">Delete</x-jet-button>
