                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="px-2 py-3 text-right text-xs font-medium tracking-wider text-gray-500 uppercase pr-2">
                                WR%
                            </th>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="text-right pr-2">{{ $player->games != 0 ? number_format((($player->wins / $player->games)*100),2) : '' }}</td>
                        </tr>
